...
object NixWriter {
  def apply(versioning: Set[(String, String)],
            repos: Set[NixRepo],
    ...
    s"""# This file was automatically generated by Sbtix. Do not edit manually.
        ...
        |  ${indent(NixRepoCollection(
         repos.toSeq.sortWith(_.toNixRef < _.toNixRef)).toNix)}
        |  ${indent(
         NixArtifactCollection(
           artifacts.toSeq.sortWith(_.toNixRef < _.toNixRef)).toNix)}
        |}
        |""".stripMargin
  }
}
...
case class NixArtifact(repoName: String,
                       relative: String,
                       url: String,
                       sha256: String)
    extends NixBuilder {
